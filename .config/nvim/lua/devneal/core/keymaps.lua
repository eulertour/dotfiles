...
vim.keymap.set("i", "jk", "<ESC>:w<CR>", { desc = "Exit insert mode and save" })
vim.keymap.set("i", "jj", "<ESC>", { desc = "Exit insert mode without saving" })
...
vim.keymap.set("n", "<leader>sx", ":q<CR>", { desc = "Close current split" })
